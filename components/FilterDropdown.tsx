  ...
  return (
    <div ref={dropdownRef} className={cn('relative', className)}>
      <button
        ...
        className={cn(
          'flex items-center gap-2 px-4 py-2 bg-surface border border-border rounded-lg text-text-primary transition-all duration-200 hover:bg-gray-50',
      ...
      {isOpen && (
        <div className="absolute top-full left-0 right-0 mt-2 bg-surface border border-border rounded-lg shadow-card z-50 animate-slide-up">
          <div className="p-4 space-y-4">
            {/* Industry Filter */}
            <div>
              <h4 className="text-sm font-medium text-text-primary mb-2">Industry</h4>
            ...
            <div>
              <h4 className="text-sm font-medium text-text-primary mb-2">Revenue Model</h4>
              <div className="flex flex-wrap gap-2">
